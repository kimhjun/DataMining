...
def cls_main():
    ...
    if bon == '1':        
        ...
        method_opt = {'1': 'lda', '2': 'qda', '3': 'rda', '4': 'logistic', '5': 'naivebayes', '6': '1r', '7': 'BE'}
        if method != '5' and method != '6' and method !='7':
        ...
        sep = input("Select the data coding format(1 = 'a b c' or 2 = 'a,b,c'):  ")
        sep_opt = {'1':' ', '2':','}
        method = input("Choose method for Classification(1 = 'LDA', 2 = 'QDA', 3 = 'RDA', 7 = 'Bagging Ensemble'):  ")
        method_opt = {'1': 'lda', '2': 'qda', '3': 'rda', '7': 'BE'}
    ...
    if method != '4' and method != '5' and method != '6' and method != '7':
